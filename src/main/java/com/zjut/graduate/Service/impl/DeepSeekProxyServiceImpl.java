...
@Service
public class DeepSeekProxyServiceImpl implements DeepSeekProxyService {
    ...
    @Autowired
    public DeepSeekProxyServiceImpl(@Qualifier("deepSeekRestTemplate") RestTemplate restTemplate) {
